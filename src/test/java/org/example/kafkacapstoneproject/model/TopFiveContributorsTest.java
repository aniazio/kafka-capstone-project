...
class TopFiveContributorsTest {
    ...
    void testAddWhenAddedSmallest() {
        ...
        assertEquals(2L, topFiveContributors.namesByCommits.first().getLeft());
        assertEquals(7L, topFiveContributors.namesByCommits.last().getLeft());
    }
    ...
    void testAddWhenAddedInTheMiddle() {
        ...
        assertEquals(5, topFiveContributors.namesByCommits.size());
        assertEquals(3L, topFiveContributors.namesByCommits.first().getLeft());
        assertEquals(7L, topFiveContributors.namesByCommits.last().getLeft());
    }
    ...
    void testAddWhenAddedTop() {
        ...
        assertEquals(5, topFiveContributors.namesByCommits.size());
        assertEquals(3L, topFiveContributors.namesByCommits.first().getLeft());
        assertEquals(10L, topFiveContributors.namesByCommits.last().getLeft());
    }
    ...
    void testRemoveWhenLast() {
        ...
        assertEquals(4, topFiveContributors.namesByCommits.size());
        assertEquals(2L, topFiveContributors.namesByCommits.first().getLeft());
        assertEquals(5L, topFiveContributors.namesByCommits.last().getLeft());
    }
}
